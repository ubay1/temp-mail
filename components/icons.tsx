...
export const NewEmailIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 16.023L19.5 19.5M13.5 16.5h-5.25A2.25 2.25 0 016 14.25V7.5A2.25 2.25 0 018.25 5.25h5.25A2.25 2.25 0 0116.5 7.5v6.75a2.25 2.25 0 01-2.25 2.25zm0 0l-3.75-3.75M13.5 16.5L16.5 13.5M12 6.75v.007" />
    </svg>
);
